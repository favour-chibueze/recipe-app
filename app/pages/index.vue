...
// const { data, error } = await useAsyncData<RecipesResponse>("recipes", () =>
...
<template>
    <main>
        <section class="bg-[#f1f1f1]">
            <div class="container flex flex-col lg:flex-row items-center py-20 gap-10">
                ...
                <div class="flex-1 order-1 lg:order-2">
                    <NuxtImg densities="x1" sizes="xs:100vw sm:667px" format="webp" src="/nuxt-course-hero.png"
                        alt="" />
                </div>
            </div>
        </section>
        <section class="py-20 container">
            ...
            <div v-else>
                <p class="text-xl">An error occurred: {{ error }}</p>
            </div>
        </section>
    </main>
</template>
